...
namespace MinVerTests.Infra
{
    internal static class CommandEx
    {
        ...
        public static async Task<ReadResult> ReadLoggedAsync(string name, string args = null, string workingDirectory = null, IEnumerable<KeyValuePair<string, string>> envVars = null)
        {
