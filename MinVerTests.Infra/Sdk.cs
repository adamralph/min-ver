...
");
        ...
        public static async Task<(Package, ReadResult)> BuildProject(string path, params (string, string)[] envVars)
        {
        ...
        public static async Task<(List<Package>, ReadResult)> Build(string path, params (string, string)[] envVars)
        {
        ...
        private static Task<ReadResult> DotNet(string args, string path, IDictionary<string, string> envVars = null)
        {
